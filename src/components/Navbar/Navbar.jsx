...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      <h1 className='logo-Name'><b>VEDANT</b></h1>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Project</p></AnchorLink>{menu==="work"?<img src={underline} />:<></> }</li>
